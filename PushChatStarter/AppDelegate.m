...
- (void)addMessageFromRemoteNotification:(NSDictionary*)userInfo updateUI:(BOOL)updateUI
{
	...
	// Alert for now will be the nickname of who has changed their details
    NSString* alertValue = [[userInfo valueForKey:@"aps"] valueForKey:@"alert"];
    
    NSString* alertText = [[userInfo valueForKey:@"aps"] valueForKey:@"msg"];
    
    NSString* fromId = [[userInfo valueForKey:@"aps"] valueForKey:@"id"];
    
    [chatViewController getJSONRequest:fromId];
    

    
	//NSMutableArray* parts = [NSMutableArray arrayWithArray:[alertValue componentsSeparatedByString:@": "]];
	message.senderName =  alertValue ; //[parts objectAtIndex:0];
	//[parts removeObjectAtIndex:0];
	message.text = alertText; //[parts componentsJoinedByString:@": "];
