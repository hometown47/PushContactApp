...
static NSString* const RecordId = @"RecordId";
...
- (NSInteger)RecordId
{
	return [[NSUserDefaults standardUserDefaults] integerForKey:RecordId];
}

- (void)setRecordId:(NSInteger)recordId
{
    
    NSString *strVal =[NSString stringWithFormat:@"%ld", (long)recordId];
    
	[[NSUserDefaults standardUserDefaults] setObject: strVal  forKey:RecordId];
}
